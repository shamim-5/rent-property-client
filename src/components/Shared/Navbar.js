...
const Navbar = ({ children }) => {
  const menuItems = (
    <>
      ...
      <li>
        <Link to="/manage">Manage Properties</Link>
      </li>
      <li>
  ...
  return (
    <div className="text-[#E0E6F0] bg-black">
      <div class="drawer">
        ...
        <div class="drawer-side">
          ...
          <ul class="menu p-4 overflow-y-auto w-48 bg-base-100">{menuItems}</ul>
        </div>
      </div>
    </div>
  );
